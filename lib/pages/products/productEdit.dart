...
class productEdit extends StatefulWidget {
  ...
  final String docId;
  final List<dynamic>? images; // Change the type to List<dynamic> initially
...
class _productEditState extends State<productEdit> {
  late String docId;
  late List<String>
      imageStrings; // Create a variable to hold the converted list
// Declare docId as a class-level variable
  @override
  void initState() {
    super.initState();

    imageStrings = (widget.images ?? []).cast<String>();
    docId = widget.docId; // Set its value in initState
    print(docId);
    print(imageStrings);
    // Use widget.data to access the data passed to the productEdit widget
    // For example, to set the text of the ad_name TextEditingController:
    ad_name.text = widget.data['productName'];
    qty.text = widget.data['qty'].toString();
    mrp.text = widget.data['mrp'].toString();
    price.text = widget.data['salePrice'].toString();

    description.text = widget.data['description'];

    // Do the same for the other TextEditingControllers
  }
